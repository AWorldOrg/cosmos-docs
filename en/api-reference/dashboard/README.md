...
The Dashboard context APIs use custom claims in the access token to enforce permissions and operations. The required custom claims for the Dashboard context are:
- `accountId`
- `workspaceId`
- `principalId`
- `userId`
