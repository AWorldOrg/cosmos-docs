# AWorld Platform Technical Specifications

**Architecture, security, compliance, and reliability**
...
AWorld is an enterprise SaaS solution for corporate engagement and continuous learning through gamification mechanics. The product is built on the AWorld technology platform, a fully serverless, API-first, cloud-native infrastructure designed with a security-first approach and GDPR compliance by design.

This document describes the AWorld infrastructure, implemented security measures, regulatory compliance, and reliability guarantees that constitute the technological foundation of AWorld.
...
- [1.6 Serverless advantages](#16-advantages-of-serverless-architecture)

### [2. Security and cybersecurity](#2-security-and-cybersecurity)
- [2.1 Data encryption](#21-data-encryption)
- [2.2 API protection](#22-api-protection)
- [2.3 Authentication](#23-authentication)
- [2.4 Authorization](#24-authorization)
- [2.5 JWT token structure](#25-jwt-token-structure)
- [2.6 Incident management](#26-security-incident-management)

### [3. Compliance and certifications](#3-compliance-and-certifications)
- [3.1 GDPR compliance](#31-gdpr-compliance)
- [3.2 Audit and traceability](#32-audit-and-traceability)
- [3.3 Data residency](#33-data-residency)
- [3.4 ISMS](#34-information-security-management-system-isms)
- [3.5 Contractual compliance](#35-contractual-compliance)

### [4. Disaster recovery and business continuity](#4-disaster-recovery-and-business-continuity)
- [4.1 Resilience architecture](#41-resilience-architecture)
- [4.2 Data replication](#42-data-replication)
- [4.3 Recovery objectives](#43-recovery-objectives)
- [4.4 Proactive monitoring](#44-proactive-monitoring)
- [4.5 Recovery procedures](#45-recovery-procedures)

### [5. Performance and scalability](#5-performance-and-scalability)
- [5.1 Performance metrics](#51-performance-metrics)
- [5.2 Automatic scalability](#52-automatic-scalability)
- [5.3 Caching strategies](#53-caching-strategies-and-media-storage)
- [5.4 Load balancing](#54-load-balancing-and-traffic-distribution)
- [5.5 Capacity and limits](#55-capacity-and-limits)
- [5.6 Idempotency](#56-idempotency-and-operation-resilience)

### [6. Access methods and integration](#6-access-methods-and-integration)
- [6.1 REST API](#61-rest-api)
- [6.2 User pre-provisioning](#62-pre-provisioning-and-user-access)
- [6.3 Trigger mode](#63-trigger-access-mode)
- [6.4 Future protocols](#64-support-for-future-protocols)
- [6.5 SSO and SAML](#65-single-sign-on-sso-and-saml)
- [6.6 Middleware and errors](#66-middleware-stack-and-error-handling)
