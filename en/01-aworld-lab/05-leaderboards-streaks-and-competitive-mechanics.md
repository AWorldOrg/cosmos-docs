This section covers AWorld Lab's **competitive and retention mechanics** — the features that sustain long-term engagement by driving competition, rewarding consistency, and providing measurable progress. Leaderboards turn point accumulation into a motivating competitive experience, while streaks reward users for regular participation. For the foundational activities and content, refer to the activities documentation. For missions and rewards that feed into these mechanics, see the missions and progression documentation.
