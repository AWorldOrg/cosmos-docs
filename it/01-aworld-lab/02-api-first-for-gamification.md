...
Il cliente è libero di definire cosa costituisce una **TDA**, adattandola al proprio contesto: un'**attività** potrebbe consistere nel *pubblicare un post*, *leggere un contenuto*, *scansionare un codice QR*, *completare un quiz*, o qualsiasi altra interazione monitorabile digitalmente.
